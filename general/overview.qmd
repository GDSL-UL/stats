...
**Week 1-6 Tuesday \@ Central Teaching Hub PCTC**

- Lecture (9 – 10 am).
- Practical PC session (10 am – 12 pm).
...
Example datasets could be accessed through Canvas or (some) on [GitHub](https://github.com/GDSL-UL/stats) Repository of the module. These include:

...
**Deadline**: Thursday 12th November 2026 - 2pm. **Word count**: 2000 words - including tables, excluding references.
...
Employing a novel dataset, i.e. not employed during the practical sessions, for the assignment will be awarded with a higher grade. For example, see other quantitative dataset from [Secondary datasets for Human Geography](https://canvas.liverpool.ac.uk/courses/84668/files/12951952?module_item_id=2424177).
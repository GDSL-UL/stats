...
\pandocbounded{\includegraphics[keepaspectratio]{labs/04.LogisticRegression_files/figure-pdf/unnamed-chunk-7-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/04.LogisticRegression_files/figure-pdf/unnamed-chunk-10-1.pdf}}
...
\textbf{Q2.} Do descripitve analysis to the new \texttt{sar\_df}
...
\textbf{Q2}. \textbf{Can you write down the findings you learnt from the
...
\textbf{Q3}. If we want to explore whether people work as independent
...
\pandocbounded{\includegraphics[keepaspectratio]{labs/04.LogisticRegression_files/figure-pdf/unnamed-chunk-25-1.pdf}}

\textbf{Answer for the model in Q3}
...
\textbf{Q4.} \textbf{Now what conclusion you can draw when comparing the

---
title: "Lab: Introduction to Exploring a Dataset"
...
**Now create a .qmd project. We use the `File -> New File -> Quarto Document..` dropdown option, and a menu will appear asking you for the document title, author, and preferred output type. You can select HTML. Call it "week1" and save it in your main folder.**

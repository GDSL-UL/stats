...
[**This should be on your personal computer. On a local machine, I suggest using the directory M: to store the folder, it can then be accessed from every other computer on campus.**]{style="color: red;"}
...
**This is what you are going to do for the practical sessions. Avoid using the Console, if not for quick calculations**
...
::: {style="red"}
**Stop here for 5 min and wait for instructions**
:::

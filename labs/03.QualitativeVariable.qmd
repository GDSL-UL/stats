...
\*\*R can only include the categorical variables in the **factor** type, so we set the new column *Region_label* in `factor()`
...
**Therefore, the percentage of persons with long-term illness in Wales and London be 5.22 % and 6.47% separately. If you got the right answers, then congratulations you can now use regression model to make prediction.**
